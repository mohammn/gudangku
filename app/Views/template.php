        ...
        <div class="main_container">
            <div class="col-md-3 left_col menu_fixed">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="<?php echo base_url(); ?>/" class="site_title"><i class="fa fa-th"></i> <span>Gudangku :)</span></a>
                    </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            <ul class="nav side-menu">
                                <li><a href="<?php echo base_url(); ?>/barangmasuk"><i class="fa fa-sign-in"></i> Barang Masuk</a>
                                </li>
                                <li><a href="<?php echo base_url(); ?>/barangkeluar"><i class="fa fa-sign-out"></i> Barang Keluar</a>
                                </li>
            ...
            <footer>
                <div class="pull-right">
                    Gudangku :) by <a href="https://mn-belajarweb.blogspot.com">MN-Belajarweb.blogspot.com</a>
                </div>
                <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
